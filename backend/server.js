...
try {
  solicitudOrganizadorRoutes = require("./routes/solicitudOrganizador.routes");
  rutasEstado.solicitudesOrganizador = { estado: "OK", error: null };
} catch (error) {
  rutasEstado.solicitudesOrganizador = {
    estado: "NO CARGÓ",
    error: error.message,
  };
